    ...
    return (
      <div className="layout-row wrap justify-content-center flex-70 app-product-list">
        {this.props.products.map((product, i) => {
          let inCartItem = this.props.cart.items.find(
                  ...
                  {inCartItem ? (
                    <div className="layout-row justify-content-between align-items-center">
                      <button
                        ...
                        onClick={() => {
                          this.props.hanldeDecreaseQuantity(product);
                        }}
                      >
                      ...
                      <button
                        ...
                        onClick={() => {
                          this.props.hanldeIncreaseQuantity(product);
                        }}
                      >
                    ...
                    <button
                      ...
                      onClick={() => {
                        this.props.handleCartClick(product);
                      }}
                    >
                      Add To Cart
                    </button>
